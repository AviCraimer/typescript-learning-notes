...
class Speedster extends Superhero {
  ...
  constructor(name: string, secretIdentity: string) {
    //Notice, the constructor has only two arguments instead of three because superPower doesn't need to be specified
...
class ShortThug {
  ...
  {
    //Instead of this, you can use the default assignment of parameters as above. However, doing so makes the arguments optional.
    //this.hp = hp
    //this.damage = damage
  }
  attack() {
